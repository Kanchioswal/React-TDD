...
test("it should add the value correctly when add is clicked once", () => {
...
test("it should add the value correctly when add is clicked twice", () => {
render(<AwesomeCounter initialValue={1} />);
const addButton = screen.getByText("Add");
userEvent.click(addButton);
userEvent.click(addButton);
...
test("it should not allow a negative number when initial value is 2 and remove is clicked 4 times ", () => {
